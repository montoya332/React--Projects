...
class AppLayoutContainer extends Component {
  ...
  renderListItem = (item, index) => (
    <ListItem key={index} value={2} onTouchTap={e => this.handleTouchTap(e, item)}>
  ...
  render() {
    return (
      <div>
        ...
        <Drawer docked={false} width={225} open={this.state.openDrawer} onRequestClose={this.handleClose}>
